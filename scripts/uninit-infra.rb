...
puts "\n[INFO] Deleting Cloud Build triggers..."
system("ruby ./scripts/destroy-cloud-build-triggers.rb")

# Delete the source repo

puts "\n[INFO] Deleting git source repo..."
system("gcloud source repos delete -q #{PROJECT_NAME}")
